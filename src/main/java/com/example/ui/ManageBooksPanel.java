...
import main.java.com.example.service.AuthorService;
import main.java.com.example.service.BookCategoryService;
import main.java.com.example.service.PublisherService;
import main.java.com.example.service.BookService;
import main.java.com.toedter.calendar.JDateChooser;
...
public class ManageBooksPanel extends JPanel {
    ...
    private void initializeUI() {
        ...
        // trong contentPanel có 2 panel nữa là controlPanel chứa các input và các nút
        // thêm sửa xóa
        // cùng với panel centerPanel
        // controlPanel thuộc phía bắc của contentPanel
        // centerPanel ==> trung tâm của contnetPanel
        // trong centerPanel lại có 2 panel nữa 1 cái để chứa chức năng tìm kiếm sắp xếp
        // ở phía bắc
    ...
    private void loadPublishers() {
        ...
        DefaultComboBoxModel<Publisher> publisherComboBoxModel = new DefaultComboBoxModel<>(
                publishers.toArray(new Publisher[0]));
    ...
    private void loadBookCategories() {
        ...
        DefaultComboBoxModel<BookCategory> categoryComboBoxModel = new DefaultComboBoxModel<>(
                categories.toArray(new BookCategory[0]));
    ...
    private void addBook() {
        try {
            ...
            if (!title.isEmpty() && !isbn.isEmpty() && categoryID > 0 && publisherID > 0 && authorID > 0
                ...
                JOptionPane.showMessageDialog(this, "Vui lòng nhập đầy đủ thông tin sách.", "Lưu ý",
    ...
    private void updateBook() {
        ...
        if (selectedBook != null) {
            try {
                ...
                // Kiểm tra các trường nhập liệu
                if (!newTitle.isEmpty() && !newIsbn.isEmpty() && newCategoryID > 0 && newPublisherID > 0
                        && newAuthorID > 0
                        && newNumberOfPages >= 0 && !newSize.isEmpty() && newPublicationDate != null) {

                    // Tạo đối tượng Book mới
                    Book updatedBook = new Book(selectedBook.getBookID(), newTitle, newIsbn, newCategoryID,
                            newPublisherID,
                    ...
                    if (bookService.updateBook(updatedBook)) {
                        ...
                        JOptionPane.showMessageDialog(this, "Không thể cập nhật sách.", "Lỗi",
            ...
            JOptionPane.showMessageDialog(this, "Vui lòng chọn một sách để cập nhật.", "Lưu ý",
                    JOptionPane.WARNING_MESSAGE);
        }
    }
    ...
    private void showBook() {
        ...
        if (selectedBook != null) {
            ...
            JOptionPane.showMessageDialog(this, "Vui lòng chọn một sách để hiển thị.", "Lưu ý",
                    JOptionPane.WARNING_MESSAGE);
        }
    }
    ...
    private void populateFields(int selectedRow) {
        ...
        DefaultComboBoxModel<BookCategory> categoryComboBoxModel = (DefaultComboBoxModel<BookCategory>) bookCategoryComboBox
                .getModel();
        DefaultComboBoxModel<Publisher> publisherComboBoxModel = (DefaultComboBoxModel<Publisher>) publisherComboBox
                .getModel();
